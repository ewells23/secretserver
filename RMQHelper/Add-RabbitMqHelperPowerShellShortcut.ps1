...
# Imports Delinea.RabbitMqHelper.PSCommands and prints a discovery banner.
$ErrorActionPreference = 'Stop'

$installDir = $PSScriptRoot
$psd1 = Join-Path $installDir 'Delinea.RabbitMqHelper.PSCommands.psd1'
$dll  = Join-Path $installDir 'Delinea.RabbitMqHelper.PSCommands.dll'

$moduleName = 'Delinea.RabbitMqHelper.PSCommands'
...
if (Test-Path $psd1) {
    ...
    Write-Warning "RabbitMQ Helper module not found in $installDir."
    Write-Warning "Expected $psd1 or $dll. Reinstall the Helper to recover."
    return
}
